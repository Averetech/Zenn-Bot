...
function getApiInfo(event) {
  ...
  let context =
    "You are an AI assistant that is very smart and give informatiom about any topic you are asked. Provide the user with the information that they want. Please be clear and CONCISE! And add 'Zenn.' inside a <strong></strong> element at the end of the answer.";
